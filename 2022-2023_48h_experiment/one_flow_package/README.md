...
- Repository "sea_ice_docker_upgrade" (https://github.com/AnnaT1990/SAR_forecast_experiment/tree/main/sea_ice_docker_upgrade) contains files needed to build a Docker image and run JupyterLab for SAR drift experiments:
